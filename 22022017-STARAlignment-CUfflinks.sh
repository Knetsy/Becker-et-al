...
do
	...
	$i --readFilesCommand zcat --outFileNamePrefix /scratch/users/dgerard/RNA-seq-rep1/MappedReads/XSattriBAM/$outSTAR --twopassMode Basic --outSAMunmapped Within --limitOutSJcollapsed \
...
do
	...
	STAR --genomeDir /scratch/users/dgerard/Ahr-Gzf1-KD/STAR.GRCm38mm10.anno79 --runThreadN 12 --readFilesIn \
        $i --readFilesCommand zcat --outFileNamePrefix /scratch/users/dgerard/RNA-seq-rep2/MappedReads/XSattriBAM/$outSTAR --twopassMode Basic --outSAMunmapped Within --limitOutSJcollapsed \
        1000000 --limitSjdbInsertNsj 1000000 --outFilterMultimapNmax 100 --outFilterMismatchNmax 33 --outFilterMismatchNoverLmax 0.3 --seedSearchStartLmax 12 --alignSJoverhangMin \
        15 --alignEndsType Local --outFilterMatchNminOverLread 0 --outFilterScoreMinOverLread 0.3 --winAnchorMultimapNmax 50 --alignSJDBoverhangMin 3 --outFilterType \
        BySJout --outSAMtype BAM SortedByCoordinate --outSAMstrandField intronMotif
...
do
        ...
        STAR --genomeDir /scratch/users/dgerard/Ahr-Gzf1-KD/STAR.GRCm38mm10.anno79 --runThreadN 12 --readFilesIn \
        $i --readFilesCommand zcat --outFileNamePrefix /scratch/users/dgerard/RNA-seq-rep3/MappedReads/XSattriBAM/$outSTAR --twopassMode Basic --outSAMunmapped Within --limitOutSJcollapsed \
        1000000 --limitSjdbInsertNsj 1000000 --outFilterMultimapNmax 100 --outFilterMismatchNmax 33 --outFilterMismatchNoverLmax 0.3 --seedSearchStartLmax 12 --alignSJoverhangMin \
        15 --alignEndsType Local --outFilterMatchNminOverLread 0 --outFilterScoreMinOverLread 0.3 --winAnchorMultimapNmax 50 --alignSJDBoverhangMin 3 --outFilterType \
        BySJout --outSAMtype BAM SortedByCoordinate --outSAMstrandField intronMotif
done
